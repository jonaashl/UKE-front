const Header = () => {
    return (
        <header class="osg-header bg-color__beige">
                ...
                <div class="osg-none osg-block-breakpoint-medium osg-full-height">
                    <div class="osg-grid osg-grid--gap osg-full-height">
                        <div class="osg-grid__column--12">
                            <div class="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center">
                                <form
                                    class="osg-margin-right-2-breakpoint-medium osg-margin-right-8-breakpoint-large"
                                    action
                                    method="GET"
                                    role="search"
                                ></form>
                                <button class="osg-button osg-button--outline osg-margin-right-4-breakpoint-medium osg-margin-right-8-breakpoint-large">
                                    Button
                                    <span class="osg-button__icon osg-button__icon--right osg-icon--fire-emblem"></span>
                                </button>
                                <button class="osg-button osg-button--outline">
                                    Button<span class="osg-button__icon osg-button__icon--right osg-icon--crane"></span>
                                </button>
                            </div>
                        </div>
                    </div>
