const Header = () => {
    return (
        <header className="osg-header bg-color__beige">
                ...
                <div className="osg-none osg-block-breakpoint-medium osg-full-height">
                    <div className="osg-grid osg-grid--gap osg-full-height">
                        <div className="osg-grid__column--12">
                            <div className="osg-full-height osg-flex osg-flex-justify-content-flex-end osg-flex-align-items-center">
                                <form
                                    className="osg-margin-right-2-breakpoint-medium osg-margin-right-8-breakpoint-large"
                                    action
                                    method="GET"
                                    role="search"
                                ></form>
                                <button className="osg-button osg-button--outline osg-margin-right-4-breakpoint-medium osg-margin-right-8-breakpoint-large">
                                    Button
                                    <span className="osg-button__icon osg-button__icon--right osg-icon--fire-emblem"></span>
                                </button>
                                <button className="osg-button osg-button--outline">
                                    Button
                                    <span className="osg-button__icon osg-button__icon--right osg-icon--crane"></span>
                                </button>
                            </div>
                        </div>
                    </div>
